...
urlpatterns = [
    ...
    path(
        "password_reset_confirm/<int:id>/<token>/",
        views.password_reset_confirm,
        name="password_reset_confirm",),
    path("create_quiz/", views.create_quiz, name="create_quiz"),
    path(
        "confirm_correctness/<str:model_name>/<int:id>/<token>/",
        views.confirm_correctness,
        name="confirm_correctness",),
    path(
        "create_question/<int:quiz_id>", views.create_question, name="create_question"),
